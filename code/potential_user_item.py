...
predict_item = pd.read_csv("F:activities/TianChi_TeamPSU/data/tianchi_mobile_recommend_train_item.csv")
# read in the potential user category list
reader = csv.reader(open('F:activities/TianChi_TeamPSU/data/potential_user_category.csv', 'rb'))
...
writer = csv.writer(open('F:activities/TianChi_TeamPSU/data/potential_user_item.csv', 'wb'))
