...
user_file = root_path + 'test_tianchi_mobile_recommend_train_user.csv'

# read in user data
user_data = pd.read_csv(user_file)
# prepare the user_behavior_statistics output file
stat_file = root_path + 'TianChi_TeamPSU/data/algorithm_II/test_user_behavior_statistics.csv'
